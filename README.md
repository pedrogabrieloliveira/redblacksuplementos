...
- 🔴 **Vermelho** (energia e performance)  
- ⚫ **Preto** (força e destaque)  
- ⚪ **Branco** (contraste e legibilidade)
...
✔ **Listagem de produtos** (via CSV/JS)  
✔ **Busca, filtros e ordenação**  
✔ **Carrinho dinâmico**  
✔ **Finalização de compra com integração ao banco**  
✔ **Sistema de pedidos**  
✔ **Envio de mensagens na página Contato**  
